...
#np.std(test_data['LotFrontage'])

#sns.regplot('LotFrontage', np.log(test_data['LotArea']), data = test_data)
...
# Replacing test data with scaled test data
for col in scaled_num_features.columns:
    if col in test_data.columns:
        test_data[col] = scaled_num_features[col]
